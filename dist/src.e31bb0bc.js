...
function css() {
  ...
  var stringFromArray = array.join(';'); //console.log(stringFromArray)
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options3 = this.options,
          ...
          style = _this$options3.style;
      return (0, _utils.row)("<img title=\"".concat(alt, "\" alt=\"").concat(alt, "\" src=\"").concat(this.value, "\"/>"), (0, _utils.css)(style));
    }
  }]);
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      var _this$options4 = this.options,
          tag = _this$options4.tag,
          style = _this$options4.style;
      var htm = this.value.map(function (item) {
        return (0, _utils.col)("<".concat(tag, ">").concat(item, "</").concat(tag, ">"), (0, _utils.css)(style));
      });
      return (0, _utils.row)("".concat(htm.join('')));
    }
  }]);
...
var _land = _interopRequireDefault(require("./assets/land.jpg"));

var _blocks = require("./classes/blocks.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('JS website constructor', {
  tag: 'h2',
  style: {
    background: '#4eaad0',
...
}), new _blocks.TextBlock('We go JS courses to learn up to Middle', {
  tag: 'h2',
  style: {
...
}), new _blocks.ColumnsBlock(['It is a big question for you if you manage to become a frontend developer', 'Russian javascript is kotlen', 'Today is Monday 22 April', 'Nobody cares you'], {
  tag: 'p',
  style: {
    border: '1px solid grey',
    padding: '20px 30px'
  }
}), new _blocks.ImageBlock(_land.default, {
  alt: 'My picture',
  style: {
...
exports.model = model;
},{"./assets/land.jpg":"assets/land.jpg","./classes/blocks.js":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function init() {
      ...
      this.el.addEventListener('submit', this.add.bind(this)); //console.log('This is ' + JSON.stringify(this))
    }
  }, {
    key: "template",
    get: function get() {
    ...
    value: function add(event) {
      ...
      var style = event.target.styles.value; //debugger
...
},{"./../utils.js":"utils.js","./blocks.js":"classes/blocks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
exports.App = App;
},{"./site":"classes/site.js","./sidebar":"classes/sidebar.js","../styles/main.css":"styles/main.css"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./model.js":"model.js","./classes/app.js":"classes/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
